...
SOAP_SOURCE_STAMP("@(#) soapServer.c ver 2.8.132 2025-11-03 17:59:43 GMT")
...
{	struct blackJackns__playerMove soap_tmp_blackJackns__playerMove;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = blackJackns__playerMove(soap, soap_tmp_blackJackns__playerMove.playerName, soap_tmp_blackJackns__playerMove.gameId, soap_tmp_blackJackns__playerMove.move, soap_tmp_blackJackns__playerMoveResponse.result);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
