...
SOAP_SOURCE_STAMP("@(#) soapClient.c ver 2.8.132 2025-10-29 14:23:23 GMT")
...
{	if (soap_send_blackJackns__playerMove(soap, soap_endpoint, soap_action, playerName, gameId, move) || soap_recv_blackJackns__playerMove(soap, result))
		return soap->error;
	return SOAP_OK;
}
